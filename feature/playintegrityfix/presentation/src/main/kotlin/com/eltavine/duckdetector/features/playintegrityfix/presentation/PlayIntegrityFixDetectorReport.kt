...
fun PlayIntegrityFixCardModel.toDetectorReport(): DetectorReport = DetectorReport(
    title = title,
    verdict = verdict,
...
private fun List<PlayIntegrityFixDetailRowModel>.toReportRows(): List<ReportRow> =
