...
fun CustomRomCardModel.toDetectorReport(): DetectorReport = DetectorReport(
    title = title,
    verdict = verdict,
    ...
    blocks = listOf(
        ...
        ReportBlock.Rows("Framework", frameworkRows.toReportRows()),
...
private fun List<CustomRomDetailRowModel>.toReportRows(): List<ReportRow> =
