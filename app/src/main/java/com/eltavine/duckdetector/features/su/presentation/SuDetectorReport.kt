...
fun SuCardModel.toDetectorReport(): DetectorReport = DetectorReport(
    title = title,
    verdict = verdict,
    ...
    blocks = listOf(
        ...
        ReportBlock.Rows("Context", contextRows.toReportRows()),
...
private fun List<SuDetailRowModel>.toReportRows(): List<ReportRow> =
