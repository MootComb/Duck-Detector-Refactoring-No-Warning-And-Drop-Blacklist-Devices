...
object DangerousAppsDetectorFeature : DetectorFeature {
    override val id: DetectorId = DangerousAppsDetectorId

    @Composable
    override fun rememberSession(): DetectorSession {
        val context = LocalContext.current
        val viewModel: DangerousAppsViewModel = viewModel(factory = remember(context) { DangerousAppsViewModel.factory(context) })
