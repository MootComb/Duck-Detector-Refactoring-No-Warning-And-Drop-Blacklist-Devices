...
fun NativeRootCardModel.toDetectorReport(): DetectorReport = DetectorReport(
    title = title,
    verdict = verdict,
    ...
    blocks = listOf(
        ...
        ReportBlock.Rows("Kernel", kernelRows.toReportRows()),
...
private fun List<NativeRootDetailRowModel>.toReportRows(): List<ReportRow> =
