...
object SystemPropertiesDetectorFeature : DetectorFeature {
    override val id: DetectorId = SystemPropertiesDetectorId

    @Composable
    override fun rememberSession(): DetectorSession {
        val viewModel: SystemPropertiesViewModel = viewModel(factory = remember { SystemPropertiesViewModel.factory() })
