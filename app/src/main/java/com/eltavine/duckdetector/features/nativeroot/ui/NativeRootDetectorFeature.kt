...
object NativeRootDetectorFeature : DetectorFeature {
    override val id: DetectorId = NativeRootDetectorId

    @Composable
    override fun rememberSession(): DetectorSession {
        val context = LocalContext.current
        val viewModel: NativeRootViewModel = viewModel(factory = remember(context) { NativeRootViewModel.factory(context) })
