 ...
 *
 * The C++ half lives in this module's `src/main/cpp/common/payload_codec.h`, and
 * `NativePayloadCodecTest` pins the two against each other. Keeping both sides on one table is what makes splitting a record on a raw
