...
├─ sdk/runtime/           # Headless composition root: detector catalog, scan API, native libraries
...
The same build also produces the headless SDK as one AAR, without any UI, published to `sdk/aar/build/repository`:
